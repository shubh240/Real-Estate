...
<body>
    ...
    <main class="page_wrepper">
        <section class="favorite-view_sec px-80">
            <div class="fav_view">
                <h2>Lender</h2>
                <p>Connect with a real estate professional to discuss your property needs and preferences.</p>
            </div>
        </section>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 d-flex align-items-baseline justify-content-between pb-30 realeast_headline">
                        <h2 class="headline_txt fs-24">Real Estate Agents in Newton, USA</h2>
                    </div>
                </div>
