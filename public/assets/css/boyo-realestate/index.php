                                                                            ...
                                                                            <div class="col-xl-3 col-lg-4 col-md-12">
                                                                                <ul class="location_dropdown ">
                                                                                    <li class="nav-item dropdown light_GRay">
                                                                                        <h6>Property Type</h6>
                                                                                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="assets/imges/icons/home.svg" alt="location" class="me-2">
                                                                                            All Types
                                                                                        </a>
                                                                                        <ul class="dropdown-menu">
                                                                                            <li><a class="dropdown-item dark" href="#"><img src="assets/imges/icons/home.svg" alt="location" class="me-3">
                                                                                                    All Types</a></li>
                                                                                            <li><a class="dropdown-item dark" href="#"><img src="assets/imges/icons/home.svg" alt="location" class="me-3">
                                                                                                    Apartments</a></li>
                                                                                            <li><a class="dropdown-item dark" href="#"><img src="assets/imges/icons/home.svg" alt="location" class="me-3">
                                                                            ...
                                                                            <div class="col-xl-6 col-lg-5 col-md-8 col-sm-8 col-12">
                                                                                <ul class="location_dropdown ">
                                                                                    <li class="nav-item dropdown ">
                                                                                        <h6>Location</h6>
                                                                                        <a class="nav-link dropdown-toggle serch_bar" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="assets/imges/icons/search.svg" alt="location" class="me-2">
                                                                                            <input type="text" name="" id="" placeholder="Search your village, city, region, or zip code">
                                                                                        </a>
                                                                                        <ul class="dropdown-menu">
                                                                                            <li>
                                                                                                <h6 class="dropdown-item dark">
                                                                                                    <img src="assets/imges/icons/c-location.svg" alt="location" class="me-2">Current
                                                                                                    Location
                                                                                                </h6>
                                                                                            <li>
                                                                                            ...
                                                                                            <li><a class="dropdown-item dark" href="#"><img src="assets/imges/icons/location_icon.svg" alt="location" class="me-2">
                                                                                                    Bengaluru, KS
                                                                                                    56010</a>
                                                                                            </li>
                                                                                            <li><a class="dropdown-item dark" href="#"><img src="assets/imges/icons/location_icon.svg" alt="location" class="me-2">
                    ...
                    <div class="col-12 d-flex align-items-baseline justify-content-between pb-30 realeast_headline">
                        ...
                        <li class="lng_menu ">
                            <ul class="lng_dropdown ">
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-offset="0,10" aria-expanded="false">View All
                                    </a>
                                    <ul class="dropdown-menu">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 ">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><img src="assets/imges/icons/location.svg" alt="location" class="me-1">
                                ...
                                <div class="card_footer d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="card_footer_btn">
                                        <a class="btn blue_btn" href="javascript:void(0)"><img src="assets/imges/icons/user.svg" alt="user" class="me-1">Contact</a>
                        ...
                        <div class="newton_card">
                            ...
                            <div class="newton_content">
                                ...
                                <p class="white">2546 Westfall Avenue
                                    Fairmont...</p>
                                <a class="btn blue_btn" href="javascript:void(0)"><img src="assets/imges/icons/user.svg" alt="user" class="me-2">Contact</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6">
